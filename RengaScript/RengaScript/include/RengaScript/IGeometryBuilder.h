...
namespace renga_script
{
  ...
  public:
    ...
    virtual ICurve3D* createLineSegment3D(const Point3D& p1, const Point3D& p2) const = 0;
    virtual ICurve3D* createArc3D(const Point3D& p1, const Point3D& p2, const Point3D& p3) const = 0;
    virtual ICurve3D* createContour3D(const ConstCurve3DVector& curves) const = 0;
    ...
    virtual ISolid* createRevolution(const ICurve2D* pBase) const = 0;
